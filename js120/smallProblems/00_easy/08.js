...
// instead of direct prototype manipulation. `Person` exposes
// method `greeting` which when called logs the provided 
// greeting test. `Shouter` is a subtype of `Person` and is
